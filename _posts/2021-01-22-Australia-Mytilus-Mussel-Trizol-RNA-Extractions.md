---
layout: post
title: Australia Mytilus Mussel Tri-Reagent RNA Extractions
date: '2021-01-22'
...
Extracting RNA from preserved *Mytilus spp* tissue using a Tri-Reagent/Direct-zol RNA Isolation Protocol written by [Johanna Harvey](https://github.com/JAHarvey).
...
This protocol was previously tested on live *M. edulis* tissue with [Maggie Schedl](https://github.com/meschedl). That work can be accessed [here](https://meschedl.github.io/MES_Puritz_Lab_Notebook/2019-03-12/Mytilus-Live-RNA-Extraction).
...
- Transfer 500 ul of liquid into spin column from [Direct-zol kit](https://github.com/meschedl/MES_Puritz_Lab_Notebook/blob/master/company-protocols/direct-zol_rna_miniprep_plus_kit.pdf)
...
__Qubit BR RNA assay__

Extracted RNA was quantified on the Qubit following the [BR RNA assay protocol](https://meschedl.github.io/MES_Puritz_Lab_Notebook/2019-03-02/Qubit-Protocol)
...
Samples were also run on the TapeStation following this [protocol](https://meschedl.github.io/MESPutnam_Open_Lab_Notebook/RNA-TapeStation-Protocol/)

See full report [here](https://drive.google.com/file/d/1eyfQTO4lE1nnhPwqhzLDv9jbmeS8q0pn/view?usp=sharing)
...
TapeStation report can be accessed [here](https://drive.google.com/file/d/1ZrSqhrr9Farz7QKH2Zv9Wrxaxs8a0WPO/view?usp=sharing).
...
__Once RNA was extracted from all the samples, [Maggie Schedl](https://github.com/meschedl) and I performed the probe synthesis steps from the [EecSeq protocol](https://github.com/jpuritz/EecSeq/blob/master/Protocol.md) to create sequence capture probes.__

The probe synthesis steps are documented here:
- [Part 1](https://meschedl.github.io/MES_Puritz_Lab_Notebook/2019-06-10/Aus-Myt-Probe-Syn-One)
- [Part 2](https://meschedl.github.io/MES_Puritz_Lab_Notebook/2019-06-11/Aus-Myt-Probe-Syn-Two)
- [Part 3](https://meschedl.github.io/MES_Puritz_Lab_Notebook/2019-06-12/Aus-Myt-Probe-Syn-Three)
- [Part 4](https://meschedl.github.io/MES_Puritz_Lab_Notebook/2019-06-13/Aus-Myt-Probe-Syn-Four)
- [Part 5](https://meschedl.github.io/MES_Puritz_Lab_Notebook/2019-06-27/Aus-Myt-Probe-Syn-Five)
- [Part 6](https://meschedl.github.io/MES_Puritz_Lab_Notebook/2019-06-28/Aus-Myt-Probe-Syn-Six)
- [Part 7](https://meschedl.github.io/MES_Puritz_Lab_Notebook/2019-07-01/Aus-Myt-Probe-Syn-seven)
